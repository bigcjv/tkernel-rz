/************************************************************************
    ...
    Copyright (c) 2015-2019 eForce Co., Ltd. All rights reserved.

    2015-08-18: Created
    2019-07-08: Add CFG_TCP_RCV_OSQ_MAX in gNET_CFG
 ************************************************************************/
...
T_NET_ADR gNET_ADR[] = {
    {
        ...
        /* 192 sample */
#if 0
        0xC0A80167,     /* IP address  (192.168.  1.103) */
        0xC0A80101,     /* Gateway     (192.168.  1.  1) */
        0xFFFFFF00,     /* Subnet mask (255.255.255.  0) */
#else
        /* 172 sample */
        0xAC100067,     /* IP address  (172.16 .  0.103) */
        0xAC100001,     /* Gateway     (172.16 .  0.  1) */
        0xFFFFFF00,     /* Subnet mask (255.255.255.  0) */
#endif
    }
};
...
extern void apl_eth_cbk(UH dev_num, UH evt, VP sts);    /* sample.c */
...
#endif
        0,
        {{{ 0x12, 0x34, 0x56, 0x78, 0x0B, 0x52 }}}, /* MAC Address */
