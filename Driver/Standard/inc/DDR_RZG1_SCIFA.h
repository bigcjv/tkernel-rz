 ...
 *            Initial version.
 */
#ifndef _DDR_RZG1_SCIFA_H_
#define _DDR_RZG1_SCIFA_H_
...
typedef union t_rzg1_scifa_msts {
    UH          word;
    struct {
        UH                  init_flg:1;
        UH                  ena_tx:1;
...
typedef struct t_rzg1_scifa_mng {
 ...
 * @param t_scifa
 */
ER _ddr_rzg1_scifa_init(ID, volatile struct t_scifa *);

#ifdef __cplusplus
}
#endif

#endif  /* _DDR_RZG1_SCIFA_H_ */
